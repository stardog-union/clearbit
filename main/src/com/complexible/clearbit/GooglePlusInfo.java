 ...
 * @version 0.1
 */
public final class GooglePlusInfo {
	...
	public boolean equals(final Object theObj) {
		...
		else if (theObj instanceof GooglePlusInfo) {
			GooglePlusInfo aObj = (GooglePlusInfo) theObj;
	...
	public String toString() {
		return String.format("Google+(%s)", mHandle);
	}
}
